...
namespace BitEx.IGrain.Events
{
    ...
    public class DepositConfirmedEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(DepositConfirmedEvent).FullName;
        [ProtoIgnore]
        public string TypeCode { get { return _TypeCode; } }
        public DateTime Timestamp { get; set; } = DateTime.Now;
        public DepositConfirmedEvent()
        {
        }
        public DepositConfirmedEvent(string commandId, string fundSourceId, string accountId, string capitalAccuntId, decimal amount, decimal txAmount, decimal fee, decimal txFee, int operatorId)
        {
