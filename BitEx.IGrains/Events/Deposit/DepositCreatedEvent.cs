...
namespace BitEx.IGrain.Events
{
    ...
    public class DepositCreatedEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(DepositCreatedEvent).FullName;
        [ProtoIgnore]
        ...
        public DepositCreatedEvent(string commandId, string userId, string currencyId, string accountId, DepositWay depositWay, string capitalAccountId, string fundSourceId, decimal amount, string remark, int identify)
        {
            ...
            if (depositWay == DepositWay.DepositCode)
