...
namespace BitEx.IGrain.Events
{
    ...
    public class MortgageRedeemingEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(MortgageRedeemingEvent).FullName;
        [ProtoIgnore]
        public string TypeCode { get { return _TypeCode; } }
        public DateTime Timestamp { get; set; } = DateTime.Now;
        public MortgageRedeemingEvent()
        {
        }
        public MortgageRedeemingEvent(string commandId, string userId, string currencyId, string depositId, string guaranteeId, bool isMortgagedVirtualCoin, string mortgagedAccountId, decimal mortgagedAmount, decimal balance, decimal depositAmount)
        {
