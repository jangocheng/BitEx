...
namespace BitEx.IGrain.Events
{
    ...
    [Immutable]
    public class CoinRollbackDepositDecreasedEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(CoinRollbackDepositDecreasedEvent).FullName;
        [ProtoIgnore]
        public string TypeCode { get { return _TypeCode; } }
        public DateTime Timestamp { get; set; } = DateTime.Now;
        public CoinRollbackDepositDecreasedEvent()
        {
        }
        public CoinRollbackDepositDecreasedEvent(string commandId, string userId, string currencyId, string depositId, decimal balance, decimal volume)
        {
