...
namespace BitEx.IGrain.Events
{
    ...
    [Immutable]
    public class CoinDepositIncreasedByManagerEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(CoinDepositIncreasedByManagerEvent).FullName;
        [ProtoIgnore]
        public string TypeCode { get { return _TypeCode; } }
        public DateTime Timestamp { get; set; } = DateTime.Now;
        public CoinDepositIncreasedByManagerEvent()
        {
        }
        public CoinDepositIncreasedByManagerEvent(string commandId, string userId, string currencyId, string depositId, decimal balance, decimal volume)
        {
