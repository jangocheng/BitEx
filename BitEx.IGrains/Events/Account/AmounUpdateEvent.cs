...
namespace BitEx.IGrain.Events.Account
{
    ...
    public class AmounUpdateEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(AmounUpdateEvent).FullName;
        [ProtoIgnore]
        public string TypeCode { get { return _TypeCode; } }
        public DateTime Timestamp { get; set; } = DateTime.Now;
        public AmounUpdateEvent()
        {
        }
        public AmounUpdateEvent(decimal addBalance, decimal balance, decimal addLocked, decimal locked, decimal addMortgaged, decimal mortgaged, string operatorId, string remark)
        {
