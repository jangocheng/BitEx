...
namespace BitEx.IGrain.Events
{
    ...
    public class MarketPlanOrderChangedEvent : IEventBase<string>
    {
        ...
        private static string _TypeCode = typeof(MarketPlanOrderChangedEvent).FullName;
        [ProtoIgnore]
        public string TypeCode { get { return _TypeCode; } }
        public DateTime Timestamp { get; set; } = DateTime.Now;
        public MarketPlanOrderChangedEvent()
        {
        }
        public MarketPlanOrderChangedEvent(string commandId, decimal price, string orderId, string accountId)
        {
